$(document).ready(function(){
          ...
          if(i==0){
            ...
            if(i==4){
              ...
              $('#sub').css('margin-top',function(index,curVal){
                  return parseInt(curVal, 10) + 50 + 'px';                
              })
            }
          }
          $("#sub").fadeIn();
      ...
      function reslt(){
          ...
          if(score<=4){
              ...
              $('#share').attr('href','https://www.facebook.com/sharer.php?u=quiz.glico.vn&quote='+"Tôi đã trả lời đúng "+score+"/"+quelst.length+ " câu hỏi! Còn bạn thì sao ?")
          }

          else{
              $(".message").text("Chúc mừng bạn đã trả lời đúng 5/5 câu hỏi");
                $('#share').attr('href','https://www.facebook.com/sharer.php?u=quiz.glico.vn&quote='+"Tôi đã trả lời đúng 5/5 câu hỏi ! Còn bạn thì sao ?")
