$(document).ready(function(){
      ...
      function reslt(){
          ...
          if(score<=4){
              ...
              $('#share').attr('href','https://www.facebook.com/sharer.php?u=https://quiz.menhatnuoicon.com.vn/fanpage.html&quote='+"Tôi đã trả lời đúng "+score+"/"+quelst.length+ " câu hỏi. Còn bạn thì sao ?");
          }

          else{
              $(".message").text("Chúc mừng bạn đã trả lời đúng 5/5 câu hỏi");
                $('#share').attr('href','https://www.facebook.com/sharer.php?u=https://quiz.menhatnuoicon.com.vn/fanpage.html&quote='+"Tôi đã trả lời đúng 5/5 câu hỏi. Còn bạn thì sao ?")
